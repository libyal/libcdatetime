...
#include "libcdatetime_wide_split_string.h"
...
{
	libcdatetime_internal_wide_split_string_t *internal_split_string = NULL;
	static char *function                                         = "libcdatetime_wide_split_string_initialize";
	...
	internal_split_string = memory_allocate_structure(
			         libcdatetime_internal_wide_split_string_t );
	...
	if( memory_set(
	     ...
	     0,
	     sizeof( libcdatetime_internal_wide_split_string_t ) ) == NULL )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_MEMORY,
	...
	*split_string = (libcdatetime_wide_split_string_t *) internal_split_string;
...
{
	libcdatetime_internal_wide_split_string_t *internal_split_string = NULL;
	static char *function                                         = "libcdatetime_wide_split_string_free";
	...
	if( *split_string != NULL )
	{
		internal_split_string = (libcdatetime_internal_wide_split_string_t *) *split_string;
		*split_string         = NULL;
...
{
	libcdatetime_internal_wide_split_string_t *internal_split_string = NULL;
	static char *function                                         = "libcdatetime_wide_split_string_get_string";
...
{
	libcdatetime_internal_wide_split_string_t *internal_split_string = NULL;
	static char *function                                         = "libcdatetime_wide_split_string_get_number_of_segments";
...
{
	libcdatetime_internal_wide_split_string_t *internal_split_string = NULL;
	static char *function                                         = "libcdatetime_wide_split_string_get_segment_by_index";
...
{
	libcdatetime_internal_wide_split_string_t *internal_split_string = NULL;
	static char *function                                         = "libcdatetime_wide_split_string_set_segment_by_index";
