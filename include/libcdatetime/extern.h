...
#if !defined( _LIBCDATETIME_EXTERN_H )
#define _LIBCDATETIME_EXTERN_H

/* To export functions from the libcdatetime DLL define LIBCDATETIME_DLL_EXPORT
 * To import functions from the libcdatetime DLL define LIBCDATETIME_DLL_IMPORT
